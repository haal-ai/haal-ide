...
This design helps mitigate "context rot" issues that can occur when processing large amounts of information in a single session. This context rot is mostly dues to ambiguities , distractor or needle in a hay stack. These are introduced by the USER or by the ouput of the models.
