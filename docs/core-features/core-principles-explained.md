...
OLAF allows you to define core principles that guide the AI in performing its tasks. These principles are defined in the `core/reference/core-principles.md` file or in the corresponding `.windsurf/rules/` files.
...
- `core/reference/core-principles.md` – For general-purpose agents
- `.windsurf/rules/core-principles.md` – For Windsurf agents

## Integration

This file can be edited and may also refer to Decision Records in the `data` folder, provided those are in a format acceptable to the model.
