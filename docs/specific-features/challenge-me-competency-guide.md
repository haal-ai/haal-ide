...
**Competency Path**: `core/prompts/researcher/challenge-me.md`
...
When you say "save", the system generates four files in `staging/think-tank/<subject-3-words>-YYYYMMDD-HHMM/`:
...
The system combines staging from all sources to provide:
...
- Request deeper analysis of specific staging
