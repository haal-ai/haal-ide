...
This list reflects the current Query Competency Index. All competencies are organized by role in the `core/prompts/` directory structure.
...
For exact pattern matching and workflow details, see the Query Competency Index in `core/reference/`.
