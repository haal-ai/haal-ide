...
try {
  ...
  Invoke-FileDownload -Url "$rawBase/tools/install_olaf.py" -OutFile $installerPath
  Invoke-FileDownload -Url "$rawBase/tools/select-collection.py" -OutFile $selectCollectionPath
