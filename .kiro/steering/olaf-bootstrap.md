...
Before responding to ANY user request, IF and only IF the user request includes the word "haal" or "olaf" anywhere, you MUST first load the .olaf framework condensed from `C:\Users\ppaccaud\.olaf/core/reference/.condensed/olaf-framework-condensed.md` and then `./.olaf/data/context/context-current.md`
