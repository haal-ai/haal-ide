...
class CollectionSelector:
    ...
    def __init__(self, execution_mode=2, *, local_root: str | None = None):
        ...
        # - .../.olaf/core/skills/<skill>/scripts (skill copy)
        # - .../.olaf/tools (tools copy)
        if self.script_dir.name == "tools":
            self.repo_root = self.script_dir.parent  # .../.olaf
        ...
        self.global_core_dir = self.global_olaf_dir / "core"
        ...
        self.local_core_dir = self.local_olaf_dir / "core"
