...
class OlafPaths:
    ...
    def local_core_dir(self) -> Path:
        return self.local_olaf_dir / "core"
    ...
    def global_core_dir(self) -> Path:
        return self.global_olaf_dir / "core"
...
def run_select_collection(*, paths: OlafPaths, collection_id: str, reinit: bool) -> None:
    script = paths.local_olaf_dir / "tools" / "select-collection.py"
...
def main() -> int:
    ...
    parser.add_argument("--skill-id", required=True, help="Skill folder name under .olaf/core/skills (kebab-case)")
