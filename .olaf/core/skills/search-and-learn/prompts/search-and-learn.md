...
3. **Execute Task 1**: Load and run collect-user-parameters task
4. **Execute Task 2**: Load and run validate-prerequisites task
5. **Execute Task 3**: Load and run define-learning-goals task
6. **Execute Task 4**: Load and run develop-search-strategy task
7. **Execute Task 5**: Load and run execute-systematic-search task
8. **Execute Task 6**: Load and run evaluate-synthesize-information task
9. **Execute Task 7**: Load and run apply-test-learning task
10. **Execute Task 8**: Load and run generate-learning-report task
