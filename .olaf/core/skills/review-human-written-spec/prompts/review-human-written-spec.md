...
1. Execute: `/prompts/workflow-phase-1-intake.md`
2. Execute: `/prompts/workflow-phase-2-domain-model.md`
3. Execute: `/prompts/workflow-phase-3-api-capabilities.md`
4. Execute: `/prompts/workflow-phase-4-questions-for-sme.md`
5. Execute: `/prompts/workflow-phase-5-review-packaging.md`
