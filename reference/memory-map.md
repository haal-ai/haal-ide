...
# Example usage:
# [id:core_olaf_dir]data/context/context-current.md → refers to .olaf/data/context/context-current.md
...
### Core Framework [id:ack_dir] = `[id:core_dir]`
# Example usage:
# [id:skills_dir]create-prompt/prompts/create-prompt.md → refers to skills/create-prompt/prompts/create-prompt.md
- **Competencies Directory** [id:competencies_dir] = `[id:ack_dir]competencies/`
- **Skills Directory** [id:skills_dir] = `[id:ack_dir]skills/`

### Skills Resolution
- **Local Skills Directory** [id:local_skills_dir] = `[id:core_dir]skills/`
