...
Before responding to ANY user request, IF and only IF the user request includes the word "olaf " (with a space) anywhere, you MUST first load the .olaf framework condensed from `~/.olaf/reference/.condensed/olaf-framework-condensed.md` and then `./.olaf/data/context/context-current.md`
